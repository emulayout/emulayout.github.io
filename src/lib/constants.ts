...
export const LAYOUT_CARD_HEIGHT = 467; // px — full card with stats and test area (fits 4-row layouts)
...
/** Matches `.stats-block` min-height in layout.css (11 × 1.35 × 11px). */
export const LAYOUT_CARD_STATS_HEIGHT = 163;
