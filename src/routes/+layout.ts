...
/**
 * Catalog data lives at the app-layout level because both the index and layout-detail routes need
 * the same static payloads. This also keeps app-bar features such as Quick Find and Compare usable
 * on either page.
 */
